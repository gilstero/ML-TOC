...
AREA_VALID_POLICIES = {"pag_f", "pag_nf", "greedy", "gs", "prp"}
...
def plot_MLAUTOC_all_datasets(
    ...
    *,
    ...
    if policies is None:
        policies = ["greedy", "gs", "prp", "pag_nf", "pag_f"]
    ...
    is_hetero_strict = (dataset_subdir == "heterogeneous_strictly_increasing")
    ...
    for policy in policies:
        ...
        if is_hetero_strict and policy in {"gs", "pag_f", "pag_nf"}:
            # Only draw once (use PAG-NF as representative)
            if policy != "pag_nf":
                continue
...
def main():
    ...
    # plot
    # plot_MLAUTOC_all_datasets(dataset_subdir="heterogeneous_strictly_increasing", results_dir="resultsrq1sih", title_suffix="Heterogeneous Strictly Increasing")
